...
a persistence unit "proj_final_webPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "proj_final_web\pom.xml":
...
artifact ("proj_final_web.war") is already built. You can build
