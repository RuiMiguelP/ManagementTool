...
a persistence unit "proj_final_data_serverPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "proj_final_data_server\pom.xml":
...
artifact ("proj_final_data_server.war") is already built. You can build
